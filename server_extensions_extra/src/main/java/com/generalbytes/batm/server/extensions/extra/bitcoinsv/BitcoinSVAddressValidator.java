...
public class BitcoinSVAddressValidator implements ICryptoAddressValidator {
    @Override
    public boolean isAddressValid(String address) {
        if (address == null) {
            ...
            if (address.startsWith("xpub")) {
                ...
                try {
                    byte[] checksumData = Bech32.concatenateByteArrays(Bech32.concatenateByteArrays(Bech32.getPrefixBytes("bitcoinsv"), new byte[]{0}), Bech32.decode(address));
