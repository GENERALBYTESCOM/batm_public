...
public class StartcoinExtension extends AbstractExtension{
    ...
    private static final Logger log = LoggerFactory.getLogger(StartcoinExtension.class);
    @Override
        ...
        if (walletLogin !=null && !walletLogin.trim().isEmpty()) {
            try {
                ...
                if ("startcoind".equalsIgnoreCase(walletType)) {
                    //"startcoind:protocol:user:password:ip:port:accountname"
                ...
                if ("startdemo".equalsIgnoreCase(walletType)) {
                    ...
                    if (fiatCurrency != null && walletAddress != null) {
                        return new DummyExchangeAndWalletAndSource(fiatCurrency, CryptoCurrency.START.getCode(), walletAddress);
                    }
                }
            } catch (Exception e) {
    ...
    public ICryptoAddressValidator createAddressValidator(String cryptoCurrency) {
        if (CryptoCurrency.START.getCode().equalsIgnoreCase(cryptoCurrency)) {
    ...
    public Set<String> getSupportedCryptoCurrencies() {
        ...
        result.add(CryptoCurrency.START.getCode());
        return result;
    }
}
