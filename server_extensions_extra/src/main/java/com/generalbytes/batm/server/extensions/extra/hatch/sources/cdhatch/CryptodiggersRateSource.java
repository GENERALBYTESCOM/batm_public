 ...
 *
 ************************************************************************************/
package com.generalbytes.batm.server.extensions.extra.hatch.sources.cdhatch;
...
public class CryptodiggersRateSource implements IRateSource{
    ...
    public BigDecimal getExchangeRateLast(String cryptoCurrency, String fiatCurrency) {
        if (!(CryptoCurrency.BTC.getCode().equalsIgnoreCase(cryptoCurrency) || CryptoCurrency.HATCH.getCode().equalsIgnoreCase(cryptoCurrency))) {
            return null;
        }
