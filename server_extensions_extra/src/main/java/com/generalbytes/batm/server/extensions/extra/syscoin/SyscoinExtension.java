...
public class SyscoinExtension extends AbstractExtension{
    ...
    private static final Logger log = LoggerFactory.getLogger(SyscoinExtension.class);
    @Override
            ...
            try {
                ...
                if ("sysdemo".equalsIgnoreCase(walletType)) {
                    ...
                    if (fiatCurrency != null && walletAddress != null) {
                        return new DummyExchangeAndWalletAndSource(fiatCurrency, CryptoCurrency.SYS.getCode(), walletAddress);
                    }
                }
            } catch (Exception e) {
    ...
    public ICryptoAddressValidator createAddressValidator(String cryptoCurrency) {
        if (CryptoCurrency.SYS.getCode().equalsIgnoreCase(cryptoCurrency)) {
