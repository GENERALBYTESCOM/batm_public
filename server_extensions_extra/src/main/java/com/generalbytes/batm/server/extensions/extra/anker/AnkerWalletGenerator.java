...
public class AnkerWalletGenerator implements IPaperWalletGenerator {

    private static final Logger log = LoggerFactory.getLogger("batm.master.AnkerWalletGenerator");
    private String prefix;
    private IExtensionContext ctx;

    public AnkerWalletGenerator(String prefix, IExtensionContext ctx) {
        this.prefix = prefix;
        this.ctx = ctx;
    }
    ...
    public IPaperWallet generateWallet(String cryptoCurrency, String oneTimePassword, String userLanguage) {
        ...
        String privateKey = wt.generateWalletPrivateKeyWithPrefix(prefix, CryptoCurrency.ANK.getCode());
        String address = wt.getWalletAddressFromPrivateKey(privateKey, CryptoCurrency.ANK.getCode());
        ...
        return new AnkerPaperWallet(cryptoCurrency, content, address, privateKey, messageText,"application/zip", "zip");
    }
