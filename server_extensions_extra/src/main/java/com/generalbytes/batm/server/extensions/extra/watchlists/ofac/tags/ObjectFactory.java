 ...
 * generated in the com.generalbytes.batm.server.extensions.extra.watchlists.ofac.tags package. 
...
public class ObjectFactory {
    ...
    private final static QName _From_QNAME = new QName("https://sanctionslistservice.ofac.treas.gov/api/PublicationPreview/exports/ADVANCED_XML", "From");
    private final static QName _To_QNAME = new QName("https://sanctionslistservice.ofac.treas.gov/api/PublicationPreview/exports/ADVANCED_XML", "To");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.generalbytes.batm.server.extensions.extra.watchlists.ofac.tags
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://sanctionslistservice.ofac.treas.gov/api/PublicationPreview/exports/ADVANCED_XML", name = "From")
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://sanctionslistservice.ofac.treas.gov/api/PublicationPreview/exports/ADVANCED_XML", name = "To")
