 ...
 *
 ************************************************************************************/
package com.generalbytes.batm.server.extensions.extra.sum;
...
import com.generalbytes.bitrafael.tools.wallet.dash.WalletToolsSUM;
...
public class SumWalletGenerator implements IPaperWalletGenerator {

    private static final Logger log = LoggerFactory.getLogger("batm.master.SumWalletGenerator");
    private String prefix;
    private IExtensionContext ctx;

    public SumWalletGenerator(String prefix, IExtensionContext ctx) {
        this.prefix = prefix;
        this.ctx = ctx;
    }
    ...
    public IPaperWallet generateWallet(String cryptoCurrency, String oneTimePassword, String userLanguage) {
        WalletToolsSUM wt = new WalletToolsSUM();
        String privateKey = wt.generateWalletPrivateKeyWithPrefix(prefix, CryptoCurrency.SUM.getCode());
        String address = wt.getWalletAddressFromPrivateKey(privateKey, CryptoCurrency.SUM.getCode());
        ...
        return new SumPaperWallet(cryptoCurrency, content, address, privateKey, messageText,"application/zip", "zip");
    }
