...
import com.generalbytes.batm.server.extensions.extra.goldcoin.test.PRS;
...
public class GoldCoinPaymentSupport extends AbstractRPCPaymentSupport {
    private GoldCoinAddressValidator addressValidator = new GoldCoinAddressValidator();
    ...
    public String getCurrency() {
        return CryptoCurrency.GLC.getCode();
    }
