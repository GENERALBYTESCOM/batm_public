 ...
 *
 ************************************************************************************/
package com.generalbytes.batm.server.extensions.extra.bitcore.wallets.bitcored;
...
public class BitcoredRPCWallet implements IWallet{
    ...
    private static final String CRYPTO_CURRENCY = CryptoCurrency.BTX.getCode();
    ...
    public String sendCoins(String destinationAddress, BigDecimal amount, String cryptoCurrency, String description) {
        if (!CRYPTO_CURRENCY.equalsIgnoreCase(cryptoCurrency)) {
            log.error("Bitcored wallet error: unknown cryptocurrency.");
            return null;
        }

        log.info("Bitcored sending coins from " + accountName + " to: " + destinationAddress + " " + amount);
        try {
    ...
    public BigDecimal getCryptoBalance(String cryptoCurrency) {
        if (!CRYPTO_CURRENCY.equalsIgnoreCase(cryptoCurrency)) {
            log.error("Bitcored wallet error: unknown cryptocurrency: " + cryptoCurrency);
            return null;
        }
        try {
