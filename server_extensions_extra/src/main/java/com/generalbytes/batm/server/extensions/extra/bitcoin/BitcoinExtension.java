...
import com.generalbytes.batm.server.extensions.extra.bitcoin.exchanges.aqua.aquaExchange;
...
public class BitcoinExtension extends AbstractExtension {
    ...
    public IExchange createExchange(String paramString) {
        ...
        if ((paramString != null) && (!paramString.trim().isEmpty())) {
            ...
            if ("bitfinex".equalsIgnoreCase(prefix)) {
            ...
            }  else if ("aqua".equalsIgnoreCase(prefix)) {
                String apiKey = paramTokenizer.nextToken();
                String apiSecret = paramTokenizer.nextToken();
                String preferredFiatCurrency = FiatCurrency.CAD.getCode();
                if (paramTokenizer.hasMoreTokens()) {
                ...
                return new aquaExchange(apiKey, apiSecret, preferredFiatCurrency);
            }
        }
        } catch (Exception e) {
    ...
    public IRateSource createRateSource(String sourceLogin) {
        ...
        if (sourceLogin != null && !sourceLogin.trim().isEmpty()) {
            ...
            if ("btcfix".equalsIgnoreCase(rsType)) {
                ...
                return new BitbuyExchange(apiKey, apiSecret, preferredFiatCurrency);
            } else if ("aqua".equalsIgnoreCase(rsType)) {
                String apiKey = st.nextToken();
                String apiSecret = st.nextToken();
                String preferredFiatCurrency = FiatCurrency.CAD.getCode();
                if (st.hasMoreTokens()) {
