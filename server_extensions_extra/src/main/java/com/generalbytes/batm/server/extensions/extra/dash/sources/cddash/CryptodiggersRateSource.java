...
public class CryptodiggersRateSource implements IRateSource{
	...
	final ClientConfig config = new ClientConfig();
        try {
            ...
            final com.generalbytes.batm.server.extensions.util.net.CompatSSLSocketFactory socketFactory = new CompatSSLSocketFactory(sslcontext.getSocketFactory());
    ...
    public BigDecimal getExchangeRateLast(String cryptoCurrency, String fiatCurrency) {
        if (!(CryptoCurrency.BTC.getCode().equalsIgnoreCase(cryptoCurrency) || CryptoCurrency.DASH.getCode().equalsIgnoreCase(cryptoCurrency))) {
            return null;
        }
