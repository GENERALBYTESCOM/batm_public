...
public class GroestlcoinPaymentSupport extends AbstractRPCPaymentSupport {
    private static final Logger log = LoggerFactory.getLogger(GroestlcoinPaymentSupport.class);

    private GroestlcoinAddressValidator addressValidator = new GroestlcoinAddressValidator();
