...
public class AeternityRPCWallet extends RPCWallet {
    public AeternityRPCWallet(String rpcURL, String accountName) {
        super(rpcURL, accountName, CryptoCurrency.AE.getCode());
    }
}
