...
public class BitcoinCashWalletGenerator implements IPaperWalletGenerator {

    private static final Logger log = LoggerFactory.getLogger("batm.master.BitcoinWalletGenerator");
    private String prefix;
    private IExtensionContext ctx;

    public BitcoinCashWalletGenerator(String prefix, IExtensionContext ctx) {
        this.prefix = prefix;
        this.ctx = ctx;
    }
    ...
    public IPaperWallet generateWallet(String cryptoCurrency, String oneTimePassword, String userLanguage) {
        ...
        privateKey = "bitcoincash:" + privateKey;
        ...
        return new BitcoinCashPaperWallet(cryptoCurrency, content, address, privateKey, messageText,"application/zip", "zip");
    }
