...
package com.generalbytes.batm.server.extensions.extra.betverse.sources.fixed;
...
public class BetVerseFixedRateSource implements IRateSourceAdvanced {
    ...
    public BetVerseFixedRateSource(BigDecimal rate, String preferedFiatCurrency) {
