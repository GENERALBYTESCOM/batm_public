...
public class AnkerPaymentSupport extends AbstractRPCPaymentSupport {
    private AnkerAddressValidator addressValidator = new AnkerAddressValidator();
    ...
    public String getCurrency() {
        return CryptoCurrency.ANK.getCode();
    }
