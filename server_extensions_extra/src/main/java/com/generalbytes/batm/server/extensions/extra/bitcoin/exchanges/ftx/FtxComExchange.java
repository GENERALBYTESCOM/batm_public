...
public class FtxComExchange extends FtxExchange {
    private static final String SSL_URI = "https://ftx.com/";
    ...
    static {
        ...
        SUPPORTED_CRYPTOS.add(CryptoCurrency.BETVERSE_ICO.getCode());
        SUPPORTED_CRYPTOS.add(CryptoCurrency.DOGE.getCode());
        SUPPORTED_CRYPTOS.add(CryptoCurrency.ETH.getCode());
        SUPPORTED_CRYPTOS.add(CryptoCurrency.HT.getCode());
        SUPPORTED_CRYPTOS.add(CryptoCurrency.LEO.getCode());
    ...
    public FtxComExchange(String preferredFiatCurrency) {
        super(preferredFiatCurrency, SSL_URI);
    }

    public FtxComExchange(String key, String secret, String preferredFiatCurrency) {
