...
public class ExternalIdentityExampleExtension extends AbstractExtension {
    Logger log = LoggerFactory.getLogger(ExternalIdentityExampleExtension.class);

    @Override
    public String getName() {
        return "External Identity Extension (example)";
    }
