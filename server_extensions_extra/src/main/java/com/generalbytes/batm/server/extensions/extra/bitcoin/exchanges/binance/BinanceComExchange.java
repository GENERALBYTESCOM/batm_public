...
public class BinanceComExchange extends BinanceExchange {
    ...
    static {
        ...
        SUPPORTED_CRYPTOS.add(new SupportedCryptoCurrency(CryptoCurrency.BET_VERSE.getCode()));
        SUPPORTED_CRYPTOS.add(new SupportedCryptoCurrency(CryptoCurrency.BET_VERSE_ICO.getCode()));
