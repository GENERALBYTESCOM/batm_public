...
public class BinanceComExchange extends BinanceExchange {
    ...
    static {
        ...
        SUPPORTED_CRYPTOS.add(new SupportedCryptoCurrency(CryptoCurrency.BVT.getCode()));
        SUPPORTED_CRYPTOS.add(new SupportedCryptoCurrency(CryptoCurrency.BVTOKENATMICO.getCode()));
