...
public class BinanceComExchange extends BinanceExchange {
    ...
    static {
        ...
        SUPPORTED_CRYPTOS.add(new SupportedCryptoCurrency(CryptoCurrency.BTOKEN.getCode()));
        SUPPORTED_CRYPTOS.add(new SupportedCryptoCurrency(CryptoCurrency.BTOKENICO.getCode()));
