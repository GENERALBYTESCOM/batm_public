...
printf "\n\n### -a get-wbalance -n shadowcashd -p protocol:user:password:host:port:accountname ###\n\n"
./tester-shadow.sh -j ../../server_extensions_extra/target/batm-server-extensions-extra-0.1-SNAPSHOT-jar-with-dependencies.jar -a get-wbalance -n shadowcashd -p http:testuser:testpassword:localhost:51736
