...
* **server_extensions_extra** - reference extension implementation that implements BTC, LTC, SYS, DASH,FLASH, DOGE, NLG, ICG, NBT, GRS and MAX coin support functionality.
