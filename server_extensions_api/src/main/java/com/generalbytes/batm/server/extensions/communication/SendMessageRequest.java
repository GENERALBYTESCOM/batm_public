...
public class SendMessageRequest {
    ...
    private @NonNull String credentials;
     ...
     */
    private @Nullable String templateContent;
     ...
     */
    private @NonNull Map<String, String> placeholders = new HashMap<>();
     ...
     */
    private @Nullable String customerLanguage;
     ...
     */
    private @NonNull String messageText;
