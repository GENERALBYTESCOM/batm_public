...
import com.generalbytes.batm.server.extensions.PhoneLineType;

public interface IPhoneLookupProvider {
     ...
     * @return Phone line type of given phone number.
     */
    IPhoneLineTypeResponse getPhoneTypeByPhoneNumber(String phoneNumberInternational);
}
