...
public interface ICommunicationProvider {
     ...
     * {@link SendMessageRequest#getMessageText()}, so plain-text-only providers need no changes.
     */
    default @NonNull ISmsResponse sendMessage(@NonNull SendMessageRequest request) {
